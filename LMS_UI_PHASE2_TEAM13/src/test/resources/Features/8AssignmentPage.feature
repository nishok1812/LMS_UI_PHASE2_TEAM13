...
Feature: Validating Assignment Page
  ...
  Scenario: Validate landing in Assignment Page
    ...
    Then Admin should see URL with "Manage Assignment Page"
  ...
  Scenario: Capture the response time for navigating to Assignment Page
    Given Admin is on dashboard page after Login
    When Admin clicks "Assignment" on the navigation bar
    Then Admin should see able to capture Response time from the URL with "Manage Assignment Page"
  ...
  Scenario: Validating text in Manage Assignment Page
    Given Admin is on dashboard page after Login
    When Admin clicks "Assignment" on the navigation bar
    Then Admin should see correct spelling for all the fields on "Manage Assignment Page"
  ...
  Scenario: Validate Add A New Assignment button
    Given Admin is on dashboard page after Login
    When Admin clicks "Assignment" on the navigation bar
    Then Admin should see a "+A New Assignment" button on the "Manage Assignment Page"
  ...
  Scenario: Validate the number of entries displaying
    Given Admin is on dashboard page after Login
    When Admin clicks "Assignment" on the navigation bar
    Then Admin should see the text as "Showing x to y of z entries" below the data table and above the footer.
  ...
  Scenario Outline: Validate Search by  Assignment Name,Assignment Description,Assignment Due Date, Assignment Grade with Valid Data
    ...
    When Admin enters from the given "<SheetName>" and "<RowNumber>" to be searched
  ...
  Scenario: Validate input fields in Assignment details popup window 
	...
	Scenario: Validate text box present in Assignment details popup window
		Given Admin is on Manage Assignment Page
    When Admin clicks <Add New Assignment> button
    Then Admin should see 8 textbox should be  present in Assignment details popup window
  ...
  Scenario: Validate Cancel/Close(X) button is present in Assignment details popup window
    ...
    Then Admin should see Cancel/Close(X) button in the Assignment detail popup window  
  		...
  		@Assignment_TC_029
  Scenario Outline: Validate that Admin able to add new assignment with valid data in mandatory fields
  	Given Admin is on Manage Assignment Page and clicks on Add New Assignment to open assignment details popup window
  	When Admin enters all mandatory field values with valid data from  "<Sheet Name>" and "<Row Number>" and clicks on save button
      ...
      | Assignment Data        |          9 |
  		...
  		#AddNewAssignmentValidation
  		@Assignment_TC_030
  Scenario Outline: Validate that Admin able to add new assignment with invalid data in mandatory fields
  	Given Admin is on Manage Assignment Page and clicks on Add New Assignment to open assignment details popup window
  	When Admin enters all mandatory field values with invalid data from  "<Sheet Name>" and "<Row Number>" and clicks on save button
  	Then Admin should see Error message in alert "Mandatory Fields need to be filled."
      ...
      | Assignment Data        |          10 |
  		...
  		#AddNewAssignmentValidation
  		@Assignment_TC_031
  Scenario Outline: Validate that Admin able to add new assignment with valid data in all fields
  	Given Admin is on Manage Assignment Page and clicks on Add New Assignment to open assignment details popup window
  	When Admin enters all field values with valid data from  "<Sheet Name>" and "<Row Number>" and clicks on save button
  	Then Admin should see new assignment details is added in the data table
      ...
      | Assignment Data        |          11 |
  		...
  		#AddNewAssignmentValidation
  		@Assignment_TC_032
  Scenario Outline: Validate that Admin able to add new assignment with invalid data in optional fields
  	Given Admin is on Manage Assignment Page and clicks on Add New Assignment to open assignment details popup window
  	When Admin enters optional fields with invalid data from  "<Sheet Name>" and "<Row Number>" and clicks on save button
      ...
      | Assignment Data        |          12 |
  		...
  		#AddNewAssignmentValidation
  		@Assignment_TC_033
  Scenario Outline: Validate that Admin able to add new assignment with missing Program Name
  	Given Admin is on Manage Assignment Page and clicks on Add New Assignment to open assignment details popup window
  	When Admin enters valid data in all fields except Program Name with no data from  "<Sheet Name>" and "<Row Number>" and clicks on save button
  	Then Admin should see "Program Name is Missing" alert
      ...
      | Assignment Data        |          13 |    
  		...
  		#AddNewAssignmentValidation
  		@Assignment_TC_034
  Scenario Outline: Validate that Admin able to add new assignment with missing Batch Number
  	Given Admin is on Manage Assignment Page and clicks on Add New Assignment to open assignment details popup window
  	When Admin enters valid data in all fields except Batch Number with no data from  "<Sheet Name>" and "<Row Number>" and clicks on save button
  	Then Admin should see "Batch Number is Missing" alert
      ...
      | Assignment Data        |          14 |      
  		...
  		#AddNewAssignmentValidation
  		@Assignment_TC_035
  Scenario Outline: Validate that Admin able to add new assignment with missing Assignment name
  	Given Admin is on Manage Assignment Page and clicks on Add New Assignment to open assignment details popup window
  	When Admin enters valid data in all fields except Assignment name with no data from  "<Sheet Name>" and "<Row Number>" and clicks on save button
  	Then Admin should see "Assignment name is Missing" alert
      ...
      | Assignment Data        |          15 |    
  		...
  		#AddNewAssignmentValidation
  		@Assignment_TC_036
  Scenario Outline: Validate that Admin able to add new assignment with missing Assignment due date
  	Given Admin is on Manage Assignment Page and clicks on Add New Assignment to open assignment details popup window
  	When Admin enters valid data in all fields except Assignment due date with no data from  "<Sheet Name>" and "<Row Number>" and clicks on save button
  	Then Admin should see "Assignment due date is Missing" alert
      ...
      | Assignment Data        |          16 |    
  		...
  		#AddNewAssignmentValidation
  		@Assignment_TC_037
  Scenario Outline: Validate that Admin able to add new assignment with missing Grade by
  	Given Admin is on Manage Assignment Page and clicks on Add New Assignment to open assignment details popup window
  	When Admin enters valid data in all fields except Grade by with no data from  "<Sheet Name>" and "<Row Number>" and clicks on save button
  	Then Admin should see "Grade by is Missing" alert
      ...
      | Assignment Data        |          17 |  
  		...
  		#AddNewAssignmentValidation
  		@Assignment_TC_038
  Scenario Outline: Validate that Admin able to add new assignment with passing past date
  	Given Admin is on Manage Assignment Page and clicks on Add New Assignment to open assignment details popup window
  	When Admin enters valid data in all fields except Assignment due date with passing past date from  "<Sheet Name>" and "<Row Number>" and clicks on save button
  	Then Admin should see "Assignment cannot be created for the passed date" alert
  ...
  Scenario Outline: Validate admin able to update assignment with valid data in mandatory fields
  	...
  	When Admin enters all mandatory field values with valid data from from  "<Sheet Name>" and "<Row Number>" and clicks save button
  ...
  Scenario Outline: Validate admin able to update assignment with invalid data in mandatory fields
  	Given Given Admin is on Manage Assignment Page and clicks on Edit button to open Edit assignment details popup window
  	When Admin enters all mandatory field values with invalid data from from  "<Sheet Name>" and "<Row Number>" and clicks save button
  	Then Admin should see Error message in alert
  ...
  Scenario: Validate admin able to update assignment missing Assignment name
  	...
  	Then Admin should see "Assignment name is Missing" alert    
  		...
  		#EditAssignmentValidation
  		@Assignment_TC_054
  Scenario: Validate admin able to update assignment missing Assignment due date
  	Given Admin is on Manage Assignment Page and clicks on Edit New Assignment to open Edit assignment details popup window
  ...
  Scenario: Validate  admin able to update assignment passing past date
  	...
  	Then Admin should see "Assignment cannot be updated for the passed date" alert
  ...
  Scenario: Verify sheet one is displayed on default in data table
    ...
    Then Admin should see that Data table displays 1 page  when entries available
  ...
  Scenario: Verify  right arrow is enable when sheet one is displayed in data table
    Given Admin is in manage assignment page 
    When Admin is in manage assignment page
    Then Admin should see that Right arrow should be enabled in page one  when entries are more than 5 available
  ...
  Scenario: Verify  left arrow is enable when sheet one is displayed in data table
    Given Admin is in manage assignment page 
    When Admin is in manage assignment page
    Then Admin should see that left arrow should be enabled in page one  when entries are more than 5 available
  ...
  Scenario: Verify  right arrow is enable when sheet two is displayed in data table when entries are more than 10
    Given Admin is in manage assignment page 
    When Admin is in manage assignment page
    Then Admin should see that Right arrow should be enabled in page two when entries are more than 10 available
  ...
  Scenario: Verify  right arrow is disable when sheet two is displayed in data table when entries are less than 10
    Given Admin is in manage assignment page 
    When Admin is in manage assignment page
    Then Admin should see that Data table displays  page 1  when entries available 
  ...
  Scenario: Verify pagination controls enabled
    Given Admin is in manage assignment page 
    When Admin is in manage assignment page
    Then Admin should see that entries are more than 5 in data table pagination controls enabled
  ...
  Scenario: Verify pagination controls disabled
    Given Admin is in manage assignment page 
    When Admin is in manage assignment page
    Then Admin should see that entries are less than 5 in data table pagination controls disabled
  ...
  Scenario: Verify next page is enabled
    ...
    Then Admin should see that if total class entries above 5 next page is enabled ( On multiples of 5 new page will be enabled)
